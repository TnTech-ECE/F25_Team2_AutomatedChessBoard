...
Eff: 90% Avg
Handles Charging of 4x 18650 Batteries (~146Wh claimed)
Output: 5V Rail
|
v
5V Rail
...
| Batteries (18650 3.7V, 9900mAh) | Generic/Unbranded | N/A (3.7V Rechargeable, Button-Top) | Amazon | B0F1CVP2L9 | 4 | $16.99 (pack of 4) | [Link](https://www.amazon.com/dp/B0F1CVP2L9) |
...
Switching to higher-capacity 9900mAh 18650 batteries (claimed) extends runtime from ~2.15 hours to ~6.55 hours at the average 22.35W system draw, providing greater portability for extended gameplay sessions. However, charging time may increase to ~10–12 hours due to UPS HAT current limits (~2–3A total), though pass-through charging ensures uninterrupted use when plugged in. Actual capacity should be verified, as generic 18650 listings often overstate mAh (real ~2000–3000mAh), potentially reducing effective runtime back toward original estimates. This upgrade enhances sustainability by reducing recharge frequency but maintains compatibility with all safety and regulatory standards.
