...
DIY implementations offer customizability and enable source code analysis. However, many such projects remain incomplete or lack essential successive revisions to achieve a well-formed, formalized state. Below is a survey of several GitHub projects that reasonably meet our project's criteria:
